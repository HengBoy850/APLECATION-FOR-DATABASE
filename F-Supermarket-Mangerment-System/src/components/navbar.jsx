...
//           nav.main-navbar {
//             left: ${sidebarCollapsed ? "68px" : "256px"};
//           }
//         }
//       `}</style>

//       <nav className="main-navbar fixed top-0 right-0 left-0 h-16 bg-white border-b border-[#E7E2D8] z-50 font-sans transition-all duration-300">
...
//                 <h4 className="text-sm font-semibold text-[#2B2A28]">{userName}</h4>
//                 <p className="text-xs text-[#A39A8B]">{userRole}</p>
//               </div>
//             </div>
